...
function Projets() {
  ...
  const handleProjectClick = (project, e) => {
    ...
    if (e.target.closest('.projet-toggle-btn')) {
      return;
    }
      ...
      <div className="projets-container">
        ...
        <div className="projets-list">
          {projects.map((project, index) => (
            <article
              key={project.id}
              className={`projet-item ${project.externalLink && project.link !== '#' ? 'clickable' : ''}`}
            ...
            >
              <div className="projet-header">
                <div className="projet-title-section">
                  ...
                  <div className="projet-meta">
                    <span className={`projet-status status-${project.status.toLowerCase().replace(' ', '-')}`}>
                      {project.status}
                    </span>
                    <span className="projet-date">{project.date}</span>
                  </div>
                </div>
                {project.externalLink && project.link !== '#' && (
                  <div className="projet-external-icon">
              ...
              <div className={`projet-details ${expandedProject === project.id ? 'expanded' : ''}`}>
                <div className="projet-details-content">
                  <p className="projet-full-description">{project.fullDescription}</p>
                  {project.externalLink && project.link !== '#' && (
                    <a
                      href={project.link}
